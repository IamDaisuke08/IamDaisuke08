...
namespace RestApi.Controllers
{
    ...
    public class TestItemsController : ControllerBase
    {
        ...
        {
            var testItem = await _context.TodoItems.FindAsync(id);
        ...
        {
            _context.TodoItems.Add(testItem);
            await _context.SaveChangesAsync();

            return CreatedAtAction(nameof(PostTestItem), new { id = testItem.Id }, testItem);
        }
        ...
        public async Task<IActionResult> DeleteTestItem(long id)
        {
            ...
            _context.TodoItems.Remove(testItem);
            await _context.SaveChangesAsync();
